      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="mt-4 text-slate-600 max-w-3xl mx-auto">
            ...
            into meaningful insights using SQL, Python, Excel, Power BI and Tableau.
        ...
        <div className="grid lg:grid-cols-2 gap-16 mt-20 items-center">
          ...
          >
            ...
            <p className="text-slate-600 leading-8">
              I am currently building my expertise in Data Analytics by working on
              real-world datasets and business-oriented projects. My goal is to
              become a skilled Data Analyst capable of helping organizations make
              data-driven decisions through insightful dashboards and analytical
              solutions.
            </p>
          ...
          >
            ...
            {stats.map((item, index) => (
              <div
                key={index}
                className="bg-slate-50 rounded-2xl shadow-md p-8 hover:-translate-y-2 hover:shadow-xl transition duration-300"
              >
